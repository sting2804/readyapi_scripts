package com.astaprime.protocols;

//import com.eviware.soapui.support.UISupport
import java.text.MessageFormat

class TreatmentDescriptionSource {

    private Properties properties

    TreatmentDescriptionSource() {
        properties = new Properties();
        def scriptFile = getClass().protectionDomain.codeSource.location.path
        scriptFile = scriptFile.substring(0, scriptFile.indexOf('TreatmentDescriptionSource.groovy'))
        //UISupport.showInfoMessage("ScriptPath: $scriptFile")
        properties.load(new FileInputStream(scriptFile+'treatmentDescriptions.properties'))
    }
