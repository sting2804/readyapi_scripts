...
class InCriteriaSource {
    ...
    InCriteriaSource() {
        ...
        scriptFile = scriptFile.substring(0, scriptFile.indexOf('InCriteriaSource.groovy'))
        //UISupport.showInfoMessage("ScriptPath: $scriptFile")
        properties.load(new FileInputStream(scriptFile+'inCriterias.properties'))
    }
