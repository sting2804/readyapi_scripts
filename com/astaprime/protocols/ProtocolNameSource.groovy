...
class ProtocolNameSource {
    ...
    ProtocolNameSource() {
        ...
        scriptFile = scriptFile.substring(0, scriptFile.indexOf('ProtocolNameSource.groovy'))
        //UISupport.showInfoMessage("ScriptPath: $scriptFile")
        properties.load(new FileInputStream(scriptFile+'protocolNames.properties'))
    }
