...
class ExCriteriaSource {
    ...
    ExCriteriaSource() {
        ...
        scriptFile = scriptFile.substring(0, scriptFile.indexOf('ExCriteriaSource.groovy'))
        //UISupport.showInfoMessage("ScriptPath: $scriptFile")
        properties.load(new FileInputStream(scriptFile+'exCriterias.properties'))
    }
