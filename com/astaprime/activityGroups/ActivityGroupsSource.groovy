...
class ActivityGroupsSource {
    ...
    ActivityGroupsSource() {
        ...
        scriptFile = scriptFile.substring(0, scriptFile.indexOf('ActivityGroupsSource.groovy'))
        //UISupport.showInfoMessage("ScriptPath: $scriptFile")
        properties.load(new FileInputStream(scriptFile+'ag.properties'))
    }
