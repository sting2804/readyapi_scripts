...
class MenNamesSource {
    ...
    MenNamesSource() {
        ...
        scriptFile = scriptFile.substring(0, scriptFile.indexOf('MenNamesSource.groovy'))
        //UISupport.showInfoMessage("ScriptPath: $scriptFile")
        properties.load(new FileInputStream(scriptFile+'men_names.properties'))
    }
