...
class MenMiddleNamesSource {

    private Properties properties

    MenMiddleNamesSource() {
        properties = new Properties();
        def scriptFile = getClass().protectionDomain.codeSource.location.path
        scriptFile = scriptFile.substring(0, scriptFile.indexOf('MenMiddleNamesSource.groovy'))
        //UISupport.showInfoMessage("ScriptPath: $scriptFile")
        properties.load(new FileInputStream(scriptFile+'men_middlenames.properties'))
    }
