...
class WomenMiddleNamesSource {

    private Properties properties

    WomenMiddleNamesSource() {
        properties = new Properties();
        def scriptFile = getClass().protectionDomain.codeSource.location.path
        scriptFile = scriptFile.substring(0, scriptFile.indexOf('WomenMiddleNamesSource.groovy'))
        //UISupport.showInfoMessage("ScriptPath: $scriptFile")
        properties.load(new FileInputStream(scriptFile+'women_middlenames.properties'))
    }
