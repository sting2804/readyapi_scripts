...
class WomenLastNamesSource {

    private Properties properties

    WomenLastNamesSource() {
        properties = new Properties();
        def scriptFile = getClass().protectionDomain.codeSource.location.path
        scriptFile = scriptFile.substring(0, scriptFile.indexOf('WomenLastNamesSource.groovy'))
        //UISupport.showInfoMessage("ScriptPath: $scriptFile")
        properties.load(new FileInputStream(scriptFile+'women_lastnames.properties'))
    }
