package com.astaprime.personalData.*;

//import com.eviware.soapui.support.UISupport
import java.text.MessageFormat

class MensNamesSource {
    ...
    MensNamesSource() {
        ...
        scriptFile = scriptFile.substring(0, scriptFile.indexOf('MensNamesSource.groovy'))
        //UISupport.showInfoMessage("ScriptPath: $scriptFile")
        properties.load(new FileInputStream(scriptFile+'mens_names.properties'))
    }
