...
class MenLastNamesSource {
    ...
    MenLastNamesSource() {
        ...
        scriptFile = scriptFile.substring(0, scriptFile.indexOf('MenLastNamesSource.groovy'))
        //UISupport.showInfoMessage("ScriptPath: $scriptFile")
        properties.load(new FileInputStream(scriptFile+'men_lastnames.properties'))
    }
