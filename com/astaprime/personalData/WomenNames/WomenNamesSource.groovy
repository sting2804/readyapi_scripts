...
class WomenNamesSource {
    ...
    WomenNamesSource() {
        ...
        scriptFile = scriptFile.substring(0, scriptFile.indexOf('WomenNamesSource.groovy'))
        //UISupport.showInfoMessage("ScriptPath: $scriptFile")
        properties.load(new FileInputStream(scriptFile+'women_names.properties'))
    }
