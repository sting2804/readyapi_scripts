package com.twentytwoskills.locations;
...
class LocationSource {
    ...
    LocationSource() {
        ...
        scriptFile = scriptFile.substring(0, scriptFile.indexOf('LocationSource.groovy'))
        //UISupport.showInfoMessage("ScriptPath: $scriptFile")
        properties.load(new FileInputStream(scriptFile+'locations.properties'))
    }
