package com.twentytwoskills.languages;
...
class LanguageSource {
    ...
    LanguageSource() {
        ...
        scriptFile = scriptFile.substring(0, scriptFile.indexOf('LanguageSource.groovy'))
        //UISupport.showInfoMessage("ScriptPath: $scriptFile")
        properties.load(new FileInputStream(scriptFile+'languages.properties'))
    }
