package com.twentytwoskills.objectives;

//import com.eviware.soapui.support.UISupport
import java.text.MessageFormat

class ObjectivesSource {
    ...
    ObjectivesSource() {
        ...
        scriptFile = scriptFile.substring(0, scriptFile.indexOf('ObjectivesSource.groovy'))
        //UISupport.showInfoMessage("ScriptPath: $scriptFile")
        properties.load(new FileInputStream(scriptFile+'objective.properties'))
    }
