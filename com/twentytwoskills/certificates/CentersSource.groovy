package com.twentytwoskills.centers;
...
class CentersSource {
    ...
    CentersSource() {
        ...
        scriptFile = scriptFile.substring(0, scriptFile.indexOf('CentersSource.groovy'))
        //UISupport.showInfoMessage("ScriptPath: $scriptFile")
        properties.load(new FileInputStream(scriptFile+'centers.properties'))
    }
