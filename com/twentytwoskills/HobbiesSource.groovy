package com.twentytwoskills.hobbiess;
...
class HobbiesSource {
    ...
    HobbiesSource() {
        ...
        scriptFile = scriptFile.substring(0, scriptFile.indexOf('HobbiesSource.groovy'))
        //UISupport.showInfoMessage("ScriptPath: $scriptFile")
        properties.load(new FileInputStream(scriptFile+'hobbies.properties'))
    }
