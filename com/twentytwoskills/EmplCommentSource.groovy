package com.twentytwoskills.comments;

//import com.eviware.soapui.support.UISupport
import java.text.MessageFormat

class EmplCommentSource {
    ...
    EmplCommentSource() {
        ...
        scriptFile = scriptFile.substring(0, scriptFile.indexOf('EmplCommentSource.groovy'))
        //UISupport.showInfoMessage("ScriptPath: $scriptFile")
        properties.load(new FileInputStream(scriptFile+'comments.properties'))
    }
