package com.astaprime.companies;

//import com.eviware.soapui.support.UISupport
import java.text.MessageFormat

class SpecialitySource {
    ...
    SpecialitySource() {
        ...
        scriptFile = scriptFile.substring(0, scriptFile.indexOf('SpecialitySource.groovy'))
        //UISupport.showInfoMessage("ScriptPath: $scriptFile")
        properties.load(new FileInputStream(scriptFile+'specialities.properties'))
    }
